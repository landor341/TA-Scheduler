...
urlpatterns = [
    ...
    path('course/<str:course_code>/<str:semester_name>/', CourseView.as_view(), name='course_view'), #selected_course view (course view)
    ...
    path('edit-course/<str:code>/<str:semester>/', CourseForm.as_view(), name='course-form'),  # Edit Course-form
